...
int gbv_order(Library *lib, const char *archive, const char *criteria)
{
  ...
  else if(strcmp(criteria, "nome_ao_contrario") == 0)
    qsort(lib->docs, lib->count, sizeof(Document), cmp_name2);
  else if(strcmp(criteria, "offset") == 0)
    qsort(lib->docs, lib->count, sizeof(Document), cmp_offset);
  else
    return 1;
